...
public class TCPPacketReceiverTest {
	...
	private TCPConnectionConfiguration l = new DefaultTCPConnectionConfiguration();

	@Test
	public void testATypicalHttpConnection() throws IOException {
		PacketReceiverImpl receiver = new PacketReceiverImpl(l);
	...
	private void shakehands(PacketReceiverImpl receiver, long initLocalSeq, long initServerSeq) throws IOException {
